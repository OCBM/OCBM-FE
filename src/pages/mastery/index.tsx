  ...
  return (
    <div className="flex justify-center items-center flex-grow">
      <div className="flex gap-6 items-center justify-center">
        ...
        <div className="flex flex-col gap-5 items-center justify-center px-16 py-12 rounded-2xl shadow-[0_0_6px_2px_rgba(0,0,0,0.08)]">
          <BulkUploadIcon />
          <p className="text-[#c8c8c8] text-[18px] font-medium leading-[18px]">Bulk Upload</p>
        </div>

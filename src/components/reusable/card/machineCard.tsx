  ...
  return (
    <div className="flex flex-col items-center pt-[10px] px-[10px] border-[#19c18f] border rounded-2xl relative w-[284px] h-full ">
      <div className="flex w-full justify-center relative">
        <div className="text-lg font-bold font-GothamMedium pt-3 flex justify-center items-center">{title}</div>
        {showSignals ? (
      ...
      {showValues ? (
        <div className="pt-7 flex justify-center gap-5">
          <div className="flex flex-col w-[20%] gap-1">
            ...
            <span className="text-xs">Out of spec</span>
          </div>
          <div className="flex flex-col w-[20%] gap-1">
            <span className="border border-[#FCB254] rounded-lg p-3 text-base font-bold text-[#FCB254] items-center flex justify-center">
              {thresholdValue}
            </span>
            <span className="text-xs">Threshold limit</span>
          </div>
          <div className="flex flex-col w-[20%] gap-1">
            <span className="border border-[#14A87C] rounded-lg p-3 text-base font-bold text-[#14A87C] items-center flex justify-center">
              {withinSpecValue}
            </span>
            <span className="text-xs">Within spec</span>
          </div>
        </div>
      ) : null}
      <div className="pt-7">
        <button className="bg-gradient-to-r from-[#605BFF] to-[#0A03D9] text-white text-base font-bold py-4 px-20 w-[282px] rounded-b-2xl items-center">
          View
        </button>
      </div>
    </div>
